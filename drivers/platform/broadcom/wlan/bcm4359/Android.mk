...
WLAN_CHIPSET := bcm4359
WLAN_SELECT := CONFIG_BCMDHD=m CONFIG_BCMDHD_INSMOD_NO_FW_LOAD=y \
	CONFIG_BCM4359=m CONFIG_BCMDHD_PCIE=y
ifeq ($(TARGET_PRODUCT),$(filter $(TARGET_PRODUCT),kagura kagura_us kagura_dsds keyaki keyaki_us keyaki_dsds))
WLAN_SELECT += CONFIG_DHD_USE_SCHED_SCAN=y
endif
ifeq ($(TARGET_PRODUCT),$(filter $(TARGET_PRODUCT),dora dora_us dora_dsds))
WLAN_SELECT += CONFIG_DHD_USE_SCHED_SCAN=y
endif
...
ifneq ($(SOMC_CFG_WLAN_ENABLE_DISC_TIME_LOG),)
ifneq ($(TARGET_BUILD_VARIANT), user)
WLAN_SELECT += CONFIG_SOMC_WLAN_ENABLE_DISC_TIME_LOG=$(SOMC_CFG_WLAN_ENABLE_DISC_TIME_LOG)
endif
endif
