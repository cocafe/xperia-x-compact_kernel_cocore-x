...
#ifdef DHD_ULP
	dhd_ulp_bus_txdata(bus->dhd, bus->sdh);
#endif /* DHD_ULP */
...
#endif
#ifdef DHD_ULP
		ret = dhd_ulp_bus_txctl(bus->dhd, bus->sdh, frame, len);
#else /* DHD_ULP */
...
#ifdef DHD_ULP
		if (dhd_ulp_check_ulp_txdata_state(bus->dhd, bus->sdh)) {
#endif /* DHD_ULP */
